...
export const EmailAuthPlainInputCreate = t.Object({
  ...
  verificationSendAt: t.Optional(__nullable__(t.Date())),
  verifiedAt: t.Optional(__nullable__(t.Date())),
});
...
export const EmailAuthSelect = t.Partial(
  t.Object({
    ...
    password: t.Boolean(),
    verificationSendAt: t.Boolean(),
    verifiedAt: t.Boolean(),
    userId: t.Boolean(),
    User: t.Boolean(),
    _count: t.Boolean(),
  }),
...
export const EmailAuthOrderBy = t.Partial(
  t.Object({
    ...
    verificationSendAt: t.Union([t.Literal("asc"), t.Literal("desc")], {
      additionalProperties: true,
    }),
    verifiedAt: t.Union([t.Literal("asc"), t.Literal("desc")], {
      additionalProperties: true,
    }),
