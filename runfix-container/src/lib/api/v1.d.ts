...
export interface operations {
    ...
    responses: {
      200: {
        ...
        content: {
          ...
          "text/plain": components["schemas"]["Translation"];
        };
      };
    };
  };
  patchApiTranslationsById: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["UpdateTranslation"];
        "multipart/form-data": components["schemas"]["UpdateTranslation"];
        "text/plain": components["schemas"]["UpdateTranslation"];
      };
    };
    responses: {
      200: {
