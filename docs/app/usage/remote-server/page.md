...
- sign up / signin here: `https://hanalangconnect.site/docs#tag/email-auth/POST/api/email-auth/signin-with-magic-linkcreate-with-email`

- check email

- get your user id here: `https://hanalangconnect.site/docs#tag/sessions/POST/api/sessions/who-am-i`

example for this one, the user id is `cm9cmjheo0007ughiliyj0g8y`
![get user Id](./user-id.png)


- get organization id here: `https://hanalangconnect.site/docs#tag/organizations/GET/api/organizations`

example for this one, the organization id is `cm9cmjheo000aughi21bcmhua`
![get organization id](./organization-id.png)

- get project id here: `https://hanalangconnect.site/docs#tag/projects/GET/api/projects`

example for this one, the project id is `cm9cmjheo000bughi1eo22sf1`
![get project id](./project-id.png)


- create api key here: `https://hanalangconnect.site/docs#tag/api-keys/POST/api/api-keys`
...
now you can use the api key to translate, as for the base url, use : `https://hanalangconnect.site`